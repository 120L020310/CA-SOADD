...
# + editable=true slideshow={"slide_type": ""} tags=["active-ipynb", "style-solution"]
# source_folder = "/home/user/data/0-原始数据集/VGGSound"
# dest_folder = "/home/user/data/0-原始数据集/VGGSound"
# # dest_folder = "/home/user/data/DATA/dataset/2-audiovisual/VGG-Sound"
#
...
class VGGSound(AudioVisualDataset):
    ...
    def __init__(self, root_path="/home/user/data/DATA/dataset/2-audiovisual/VGG-Sound"):
        """
        Args:
...
# + tags=["active-ipynb", "style-solution"] editable=true slideshow={"slide_type": ""}
# x = VGGSound(root_path="/home/user/data/DATA/dataset/2-audiovisual/VGG-Sound")
# -
...
# data2 = pd.read_csv(
#     "/home/user/data/DATA/dataset/0-audio/VGG-Sound/vggsound.csv",
